...
for i = 1:1:3
    fx(i) = - r2x*(cos(inputs.beta(i))-1) + r2y*sin(inputs.beta(i)) - r3x*(cos(phi(i))-1) + r3y*sin(phi(i)) ...
        + r4x*(cos(inputs.gamma(i))-1) - r4y*sin(inputs.gamma(i));
    fy(i) = - r2y*(cos(inputs.beta(i))-1) - r2x*sin(inputs.beta(i)) - r3y*(cos(phi(i))-1) - r3x*sin(phi(i)) ...
